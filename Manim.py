...
class AmazonInvention(MovingCameraScene):
    def construct(self):
        ...
        amazon_logo = ImageMobject("images/amazon_logo.png").scale(0.5)
        ...
        fire_phone = ImageMobject("images/fire_phone.png").scale(0.8)
        ...
        unsold_phones = ImageMobject("images/phone_box.png").scale(0.3)
        ...
        echo = ImageMobject("images/amazon_echo.png").scale(0.8)
        ...
        alexa_logo = ImageMobject("images/alexa_logo.png").scale(0.3).next_to(echo, DOWN)
        ...
        final_logo = ImageMobject("images/amazon_logo.png").scale(0.4).next_to(final_quote, DOWN, buff=1)
        self.play(FadeIn(final_logo))
        self.wait(3)

# To run this, you'll need Manim Community Edition.
# You will also need to place the following images in a folder named 'images':
# - amazon_logo.png
# - fire_phone.png
# - phone_box.png
# - team.svg
